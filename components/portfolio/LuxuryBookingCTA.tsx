// components/portfolio/LuxuryBookingCTA.tsx
"use client";
...
export default function LuxuryBookingCTA() {
          ...
          <div className="lg:col-span-6 relative z-10">
            ...
            >
              ...
              <p className="mt-8 text-sm md:text-lg text-[#5A5045] font-light leading-relaxed max-w-xl">
                Luxury bridal beauty is an investment in absolute confidence and timeless heritage. Secure your calendar date with Glam Professionals By Shivani in Agra and experience a celebrity-grade metamorphosis tailored exclusively for you.
              </p>
            </motion.div>
            ...
            <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl">
              ...
              >
                ...
                <p className="text-xs text-[#5A5045] font-light leading-relaxed">We strictly limit our bridal bookings to preserve premium quality and devotion for every queen.</p>
              </motion.div>
            ...
            >
              ...
              <a href="https://wa.me/919639211114" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-3 text-xs font-bold uppercase tracking-[0.2em] text-[#2A2520] relative py-2 transition-colors duration-300 hover:text-[#C8A97E]">
